...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  // TEMP: If both missing, add a visual (remove after debugging)
  const displayedAge = ageGuess !== undefined && ageGuess !== null ? ageGuess : "–";
  const displayedGender = genderGuess ? genderGuess : "–";
  return (
